  ...
  {//wrappers for visual page editor and boxed version of template
	...
	<div id="canvas">
		<div id="box_wrapper">
				...
				<div className="container">
					<div className="row">
						...
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Appointment</h1>
						</div>
			...
			<section className="ls section_padding_top_100 section_padding_bottom_110">
				<div className="container">
					<div className="row bottommargin_25">
						<div className="col-sm-12">
							<div className="calendar appointment-calendar">
								<div className="calendar-header">
									<div className="calendar-navigation text-center">
										<a href="#" className="round_button prev pull-left">
											<i className="rt-icon2-angle-left"></i>
										</a>
										<h3 className="inline-block margin_0">may 2016</h3>
										<a href="#" className="round_button next pull-right">
								...
								<div className="month-box">
									<div className="week-row">
										<div className="day-cell not-cur-month">
									...
									<div className="week-row">
										...
										<div className="day-cell">
											<span className="day-date">11</span>
										</div>
										<div className="day-cell">
											<span className="day-date">12</span>
										</div>
									</div>
									<div className="week-row selected-row">
										<div className="day-cell">
											<span className="day-date">13</span>
										</div>
										<div className="day-cell">
											<span className="day-date">14</span>
										</div>
										<div className="day-cell">
											<span className="day-date">15</span>
										</div>
										<div className="day-cell">
											<span className="day-date">16</span>
										</div>
										<div className="day-cell selected-day">
											<span className="day-date">17</span>
										</div>
										<div className="day-cell">
											<span className="day-date">18</span>
										</div>
										<div className="day-cell">
											<span className="day-date">19</span>
										</div>
									</div>
									<div className="appointment-list cs">
										<h6 className="grey bottommargin_25">Available Appointment:</h6>
										<ul>
											<li className="unavailable">
												...
												<div className="book-appointment">
													<a href="#" className="theme_button color2">Unavailable</a>
												</div>
											</li>
											<li className="unavailable">
												<div className="appointment-time">
											...
											<li>
												...
												<div className="book-appointment">
													<a href="#" className="theme_button color2">Book Appointment</a>
												</div>
											</li>
											<li>
												<div className="appointment-time">
