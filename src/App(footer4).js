...
<div id="box_wrapper">
	...
	<section className="page_breadcrumbs cs section_padding_20 columns_padding_0 table_section">
					...
					<div className="row">
						<div className="col-sm-4 text-center text-sm-left">
							<ol className="breadcrumb">
								...
								<li className="active">Footer 4</li>
							</ol>
						</div>
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Footer 4</h1>
						</div>
			...
			<footer className="page_footer ls section_padding_top_50 section_padding_bottom_0 columns_margin_0">
					...
					<div className="row">
						<div className="col-sm-4 ">
							...
							<div className="teaser text-center">
								...
								<a href="director.html" className="theme_button wide_button color1">About Page</a>
							</div>
						...
						<div className="col-sm-4 ">
							...
							<div className="teaser text-center">
								...
								<h3>Blog Posts</h3>
								<p>Check out our recent news</p>
								<a href="blog-right.html" className="theme_button wide_button color1">Blog Page</a>
							</div>
						...
						<div className="col-sm-4 ">
							...
							<div className="teaser text-center">
								...
								<h3>Our Gallery</h3>
								<p>Check out our portfolio and photos</p>
								<a href="gallery-regular.html" className="theme_button wide_button color1">Gallery Page</a>
							</div>
			...
			<section className="page_copyright ls ms section_padding_25">
				<div className="container">
					<div className="row">
						<div className="col-sm-12 text-center">
