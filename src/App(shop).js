...
<div id="box_wrapper">
	...
	<section className="page_breadcrumbs cs section_padding_20 columns_padding_0 table_section">
			...
			<section className="ls section_padding_top_110 section_padding_bottom_60">
			<div className="container">
				<div className="row">
					<div className="col-md-3 col-sm-6 text-center">
						<div className="vertical-item product-item bottommargin_30">
							<div className="item-media with_background">
								<img src="/images/shop/01.jpg" alt="" className=""/>
								<div className="media-links round">
									<a href="product-right.html" className="abs-link add_to_cart round">
										<span className="top-button empty top-button-cart"></span>
									</a>
								</div>
							</div>
							<div className="item-content">
								<h6 className="bottommargin_0 topmargin_30">
									<a href="product-right.html">indignation</a>
								</h6>
								<hr className="divider-size_2_30 bottommargin_10 topmargin_10"/>
								<span className="price">
									<span>
										<span className="amount">$300,50
										</span>
									</span>
								</span>
							</div>
					...
					<div className="col-md-3 col-sm-6 text-center">
						<div className="vertical-item product-item bottommargin_30">
							...
							<div className="item-content">
								<h6 className="bottommargin_0 topmargin_30">
									<a href="product-right.html">denounce with
										<br/> righteous</a>
								</h6>
								<hr className="divider-size_2_30 bottommargin_10 topmargin_10"/>
								<span className="price">
					...
					<div className="col-md-3 col-sm-6 text-center">
						<div className="vertical-item product-item bottommargin_30">
							...
							<div className="item-content">
								<h6 className="bottommargin_0 topmargin_30">
									<a href="product-right.html">demoralized</a>
								</h6>
								<hr className="divider-size_2_30 bottommargin_10 topmargin_10"/>
								<span className="price">
									<span>
										<span className="amount">$85,50</span>
									</span>
								</span>
							</div>
						</div>
					...
					<div className="col-md-3 col-sm-6 text-center">
						<div className="vertical-item product-item bottommargin_30">
							...
							<div className="item-content">
								<h6 className="bottommargin_0 topmargin_30">
									<a href="product-right.html">perfectly simple</a>
								</h6>
								<hr className="divider-size_2_30 bottommargin_10 topmargin_10"/>
								<span className="price">
									<span>
										<span className="amount">$125,25</span>
									</span>
								</span>
							</div>
						</div>
				...
				<div className="row bottommargin_10">
					<div className="col-md-3 col-sm-6 text-center">
						<div className="vertical-item product-item bottommargin_30">
							...
							<div className="item-content">
								<h6 className="bottommargin_0 topmargin_30">
									<a href="product-right.html">frequently
										<br/> occuranity</a>
								</h6>
								<hr className="divider-size_2_30 bottommargin_10 topmargin_10"/>
								<span className="price">
									<span>
										<span className="amount">$75,25</span>
									</span>
								</span>
							</div>
						</div>
					...
					<div className="col-md-3 col-sm-6 text-center">
						<div className="vertical-item product-item bottommargin_30">
							...
							<div className="item-content">
								<h6 className="bottommargin_0 topmargin_30">
									<a href="product-right.html">avoider worse
										<br/> plains</a>
								</h6>
								<hr className="divider-size_2_30 bottommargin_10 topmargin_10"/>
								<span className="price">
									<span>
										<span className="amount">$100,50</span>
									</span>
								</span>
							</div>
						</div>
					...
					<div className="col-md-3 col-sm-6 text-center">
						<div className="vertical-item product-item bottommargin_30">
							...
							<div className="item-content">
								<h6 className="bottommargin_0 topmargin_30">
									<a href="product-right.html">Aliqua
										<br/> alcatra</a>
								</h6>
								<hr className="divider-size_2_30 bottommargin_10 topmargin_10"/>
								<span className="price">
					...
					<div className="col-md-3 col-sm-6 text-center">
						<div className="vertical-item product-item bottommargin_30">
							...
							<div className="item-content">
								<h6 className="bottommargin_0 topmargin_30">
									<a href="product-right.html">Rump
										<br/> esse</a>
								</h6>
								<hr className="divider-size_2_30 bottommargin_10 topmargin_10"/>
								<span className="price">
				...
				<div className="row">
					...
					<div className="col-md-3 col-sm-6 text-center">
						<div className="vertical-item product-item bottommargin_30">
							...
							<div className="item-content">
								<h6 className="bottommargin_0 topmargin_30">
									<a href="product-right.html">Chicken
										<br/> pastrami</a>
								</h6>
								<hr className="divider-size_2_30 bottommargin_10 topmargin_10"/>
								<span className="price">
					...
					<div className="col-md-3 col-sm-6 text-center">
						<div className="vertical-item product-item bottommargin_30">
							...
							<div className="item-content">
								<h6 className="bottommargin_0 topmargin_30">
									<a href="product-right.html">demorilized</a>
								</h6>
								<hr className="divider-size_2_30 bottommargin_10 topmargin_10"/>
								<span className="price">
									<span>
					...
					<div className="col-md-3 col-sm-6 text-center">
						<div className="vertical-item product-item bottommargin_30">
							...
							<div className="item-content">
								...
								<span className="price">
									<span>
										<span className="amount">$300,50</span>
									</span>
								</span>
							</div>
						</div>
