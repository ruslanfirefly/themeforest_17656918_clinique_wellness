...
<header className="page_header header_white">
				<div className="container">
					<div className="row">
						...
						<div className="col-lg-10 col-md-9 text-right">
							{//<!-- main nav start -->
							}
			...
			<section className="page_breadcrumbs cs section_padding_top_50 section_padding_bottom_50">
				<div className="container">
					<div className="row">
						<div className="col-sm-12 text-center text-md-left display_table_md">
							<h1 className="small display_table_cell_md">Header 2</h1>
							<ol className="breadcrumb display_table_cell_md">
								...
								<li className="active">Header 2</li>
							</ol>
						</div>
					</div>
				</div>
