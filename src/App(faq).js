...
class App extends Component {
  constructor(props) {
    ...
    this.props = props;
    this.state = {
		cl: ["panel-collapse collapse in", "panel-collapse collapse", "panel-collapse collapse", "panel-collapse collapse"],
		cl1: ["panel-collapse collapse", "panel-collapse collapse", "panel-collapse collapse", "panel-collapse collapse"]
    };
  }
				...
				<div className="container">
					<div className="row">
						...
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">FAQ</h1>
						</div>
						...
						<div className="col-sm-6">
							...
							<div className="panel-group" id="accordion1">
								<div className="panel panel-default">
									<div className="panel-heading">
										<h4 className="panel-title">
											<a data-toggle="collapse" data-parent="#accordion1" href="#collapse1" className="collapsed" onClick={()=>{
												this.setState({cl: ["panel-collapse collapse in", "panel-collapse collapse", "panel-collapse collapse", "panel-collapse collapse"]
												})}} >
									...
									<div id="collapse1" className={this.state.cl[0]}>
								...
								<div className="panel panel-default">
									<div className="panel-heading">
										<h4 className="panel-title">
											<a data-toggle="collapse" data-parent="#accordion1" href="#collapse2" className="collapsed" onClick={()=>{
												this.setState({cl: ["panel-collapse collapse", "panel-collapse collapse in", "panel-collapse collapse", "panel-collapse collapse"]
												})}} >
												<i className="rt-icon2-comments highlight"></i>
												Dolor Sit Amet
											</a>
									...
									<div id="collapse2" className={this.state.cl[1]}>
										<div className="panel-body">
								...
								<div className="panel panel-default">
									<div className="panel-heading">
										<h4 className="panel-title">
											<a data-toggle="collapse" data-parent="#accordion1" href="#collapse3" className="collapsed" onClick={()=>{
												this.setState({cl: ["panel-collapse collapse", "panel-collapse collapse", "panel-collapse collapse in", "panel-collapse collapse"]
												})}} >
												<i className="rt-icon2-comments highlight"></i>
												Corporis Iste
											</a>
									...
									<div id="collapse3" className={this.state.cl[2]}>
										<div className="panel-body">
								...
								<div className="panel panel-default">
									<div className="panel-heading">
										<h4 className="panel-title">
											<a data-toggle="collapse" data-parent="#accordion1" href="#collapse4" className="collapsed" onClick={()=>{
												this.setState({cl: ["panel-collapse collapse", "panel-collapse collapse", "panel-collapse collapse", "panel-collapse collapse in"]
												})}} >
												<i className="rt-icon2-comments highlight"></i>
												Adipisicing Elit
											</a>
									...
									<div id="collapse4" className={this.state.cl[3]}>
										<div className="panel-body">
											Lorem ipsum dolor sit amet, consectetur adipisicing elit. At nobis omnis delectus, asperiores quo obcaecati et iste corporis necessitatibus tempora aspernatur doloribus. Ut deleniti commodi dicta distinctio sit enim quidem!
										</div>
									</div>
						...
						<div className="col-sm-6">
							<div className="panel-group" id="accordion2">
								<div className="panel panel-default">
									<div className="panel-heading">
										<h4 className="panel-title">
											<a data-toggle="collapse" data-parent="#accordion2" href="#collapse21" className="collapsed" onClick={()=>{
												this.setState({cl1: ["panel-collapse collapse in", "panel-collapse collapse", "panel-collapse collapse", "panel-collapse collapse"]
												})}} >
												<i className="rt-icon2-comments highlight"></i>
												Lorem Ipsum
											</a>
									...
									<div id="collapse21" className={this.state.cl1[0]}>
										<div className="panel-body">
											Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium amet ea dicta neque, ut quis omnis quos nam, pariatur, minus, fugit suscipit aspernatur sint ullam quas explicabo. Alias, officiis, dolor!
										</div>
									</div>
								...
								<div className="panel panel-default">
									<div className="panel-heading">
										<h4 className="panel-title">
											<a data-toggle="collapse" data-parent="#accordion2" href="#collapse22" className="collapsed" onClick={()=>{
												this.setState({cl1: ["panel-collapse collapse", "panel-collapse collapse in", "panel-collapse collapse", "panel-collapse collapse"]
												})}} >
												<i className="rt-icon2-comments highlight"></i>
												Dolor Sit Amet
											</a>
									...
									<div id="collapse22" className={this.state.cl1[1]}>
										<div className="panel-body">
											Lorem ipsum dolor sit amet, consectetur adipisicing elit. Exercitationem facere doloremque ut dolores laudantium nihil at, repudiandae est numquam fuga tempora totam sequi quidem saepe officiis sint beatae, magni fugit.
										</div>
									</div>
								...
								<div className="panel panel-default">
									<div className="panel-heading">
										<h4 className="panel-title">
											<a data-toggle="collapse" data-parent="#accordion2" href="#collapse23" className="collapsed" onClick={()=>{
												this.setState({cl1: ["panel-collapse collapse", "panel-collapse collapse", "panel-collapse collapse in", "panel-collapse collapse"]
												})}} >
												<i className="rt-icon2-comments highlight"></i>
												Corporis Iste
											</a>
									...
									<div id="collapse23" className={this.state.cl1[2]}>
										<div className="panel-body">
											Lorem ipsum dolor sit amet, consectetur adipisicing elit. At nobis omnis delectus, asperiores quo obcaecati et iste corporis necessitatibus tempora aspernatur doloribus. Ut deleniti commodi dicta distinctio sit enim quidem!
										</div>
									</div>
								...
								<div className="panel panel-default">
									<div className="panel-heading">
										<h4 className="panel-title">
											<a data-toggle="collapse" data-parent="#accordion2" href="#collapse24" className="collapsed" onClick={()=>{
												this.setState({cl1: ["panel-collapse collapse", "panel-collapse collapse", "panel-collapse collapse", "panel-collapse collapse in"]
												})}} >
												<i className="rt-icon2-comments highlight"></i>
												Adipisicing Elit
											</a>
									...
									<div id="collapse24" className={this.state.cl1[3]}>
										<div className="panel-body">
											Lorem ipsum dolor sit amet, consectetur adipisicing elit. At nobis omnis delectus, asperiores quo obcaecati et iste corporis necessitatibus tempora aspernatur doloribus. Ut deleniti commodi dicta distinctio sit enim quidem!
										</div>
									</div>
