...
<div id="box_wrapper">
	...
	<section className="page_breadcrumbs cs section_padding_20 columns_padding_0 table_section">
				<div className="container">
					<div className="row">
						...
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Contact</h1>
						</div>
			...
			<section id="map" className="ls"></section>

			<section className="ls section_padding_top_60 section_padding_bottom_100 section_padding_bottom_100">
				<div className="container">
					<div className="row">

						<div className="col-md-8 to_animate" data-animation="scaleAppear">

							<h3 className="highlight fontsize_30 topmargin_0 bottommargin_50">Contact Form</h3>

							<form className="contact-form columns_padding_5 row bold-placeholder" method="post" action="/">
								...
								<div className="col-sm-6">
									<p className="contact-form-name">
										...
										<input type="text" aria-required="true" size="30" value={this.state.fullName} onChange={(el)=>{this.setState({fullName: el.target.value})}} name="name" id="name" className="form-control" placeholder="Full Name"/>
									</p>
								</div>
								<div className="col-sm-6">
									<p className="contact-form-subject">
										...
										<input type="text" aria-required="true" size="30" value={this.state.subject} onChange={(el)=>{this.setState({subject: el.target.value})}} name="subject" id="subject" className="form-control" placeholder="Subject"/>
									</p>
								</div>
								<div className="col-sm-6">
									<p className="contact-form-phone">
										<label for="phone" className="sr-only">Phone
											<span className="required">*</span>
										</label>
										<input type="text" aria-required="true" size="30" value={this.state.phone} onChange={(el)=>{this.setState({phone: el.target.value})}} name="phone" id="phone" className="form-control" placeholder="Phone number"/>
									</p>
								</div>
								<div className="col-sm-6">
									<p className="contact-form-email">
										<label for="email" className="sr-only">Email address
											<span className="required">*</span>
										</label>
										<input type="email" aria-required="true" size="30" value={this.state.email} onChange={(el)=>{this.setState({email: el.target.value})}} name="email" id="email" className="form-control" placeholder="Email"/>
									</p>
								</div>
								<div className="col-sm-12">
									...
									<p className="contact-form-message">
										...
										<textarea aria-required="true" rows="12" cols="45" name="message" id="message" className="form-control" placeholder="Message"></textarea>
									</p>
								</div>

								<div className="col-sm-12">

									<p className="contact-form-submit topmargin_20">
										<button type="submit" id="contact_form_submit" name="contact_submit" className="theme_button wide_button color2">Send Message</button>
									</p>
								</div>
						...
						<div className="col-md-4 to_animate" data-animation="scaleAppear">
							...
							<h3 className="fontsize_30 highlight topmargin_0 bottommargin_50">Contact info</h3>
							<div className="page-meta">
								<div className="media">
									<div className="media-left media-middle">
										<i className="rt-icon2-location highlight2 fontsize_20"></i>
									</div>
									<div className="media-body">
										<p className="lusitana-bold-up fontsize_14 grey margin_0 lineheight_1">
											Livingstone, Season Street
											<span className="highlight2 fontsize_18">45/2</span>
											<br/> Los angeles,
								...
								<div className="media">
									<div className="media-left media-middle">
										<i className="rt-icon2-tablet3 highlight2 fontsize_20"></i>
									</div>
									<div className="media-body">
										<p className="lusitana-bold-up fontsize_14 grey margin_0 lineheight_1">
											<span className="highlight2 fontsize_18">1 (800) 300 2214</span>
										</p>
									</div>
								</div>
								...
								<div className="media">
									<div className="media-left media-middle">
										<i className="rt-icon2-envelope highlight2 fontsize_18"></i>
									</div>
									<div className="media-body">
										<p className="lusitana-bold-up fontsize_14 grey margin_0 lineheight_1">
											clinique@support.com
										</p>
									</div>
								</div>
							</div>
