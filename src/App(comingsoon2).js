...
const renderer = ({ hours, minutes, seconds, days}) => {
	  ...
	  return <div> <span className="countdown-amount">{days} {hours} {minutes} {seconds}</span>
	  <span class="countdown-period " >Days &nbsp; Hours&nbsp;&nbsp; Minutes&nbsp;&nbsp; Seconds</span>
	  </div>;
  };
...
<div id="box_wrapper">
	...
	<section class="page_breadcrumbs cs section_padding_20 columns_padding_0 table_section">
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4 text-center">
				<h1 class="highlight bold">Coming Soon 2</h1>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-center">
				...
				<div id="comingsoon-countdown" className="is-countdown">
							<Countdown renderer={renderer} date={Date.now() + 2592000000 }/>
							</div>
...
<section id="subscribe" class="section_subscribe cs gradient section_padding_50 table_section table_section_md columns_padding_0">
	<div class="container">
		<div class="row">
			<div class="col-lg-6 text-center text-lg-left">
				<h3 class="margin_0 fontsize_30">Subscribe to Our Newsletter Be Updated!</h3>
			</div>
				...
				<div class="widget widget_mailchimp">
					<form class="signup form-inline bold-placeholder" action="/" method="get">
						...
						<button type="submit" class="theme_button">
							<i class="rt-icon2-pen2 highlight"></i>
	...
	<div class="container">
		<div class="row display_table_md">
			...
			<div class="col-md-4 col-md-pull-4 text-center text-md-left display_table_cell_md">
				<p class="small-text grey margin_0">clinique - wellness &amp; spa resort &copy; 2016</p>
			</div>
