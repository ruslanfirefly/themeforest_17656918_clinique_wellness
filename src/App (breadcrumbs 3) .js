  ...
  {//wrappers for visual page editor and boxed version of template
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section className="page_breadcrumbs cs section_padding_top_25 section_padding_bottom_25 gradient">
				<div className="container">
					<div className="row">
						<div className="col-sm-12 text-center">
							<h1 className="grey small">Breadcrumbs 3</h1>
							<ol className="breadcrumb">
								...
								<li className="active">Breadcrumbs 3</li>
							</ol>
						</div>
					</div>
				</div>
