				...
				<div className="container">
					<div className="row">
						...
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Pricing</h1>
						</div>
				...
				<div className="container">
					...
					<div className="row">
						<div className="col-sm-4">
							...
							<div className="price-table after_cover color_bg_1 bg_teaser">
								...
								<div className="features-list">
									<ul>
										<li className="enabled">Feature 01</li>
										<li className="enabled">Feature 02</li>
										<li className="enabled">Feature 03</li>
										<li className="disabled">Feature 04</li>
										<li className="disabled">Feature 05</li>
									</ul>
								</div>
								<div className="call-to-action">
									<a href="#" className="theme_button">Order Now</a>
								</div>
							</div>
						...
						<div className="col-sm-4">
							...
							<div className="price-table after_cover color_bg_2 bg_teaser">
						...
						<div className="col-sm-4">
							...
							<div className="price-table after_cover color_bg_3 bg_teaser">
						...
						<div className="col-sm-4">
							<ul className="price-table style1">
								...
								<li className="call-to-action">
									<a href="#" className="theme_button inverse">Sign Up Now</a>
								</li>
							</ul>
						</div>
							...
							<ul className="price-table style1">
								...
								<li className="features-list">
									<ul>
										...
										<li className="enabled">Feature 02</li>
										<li className="enabled">Feature 03</li>
										<li className="enabled">Feature 04</li>
										<li className="disabled">Feature 05</li>
									</ul>
								</li>
								<li className="call-to-action">
									<a href="#" className="theme_button color1">Sign Up Now</a>
								</li>
							</ul>
						</div>
							...
							<ul className="price-table style1">
								...
								<li className="features-list">
									<ul>
										...
										<li className="enabled">Feature 03</li>
										<li className="enabled">Feature 04</li>
										<li className="enabled">Feature 05</li>
									</ul>
								</li>
								<li className="call-to-action">
									<a href="#" className="theme_button inverse">Sign Up Now</a>
