				...
				<div className="container">
					<div className="row">
						...
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Bootstrap</h1>
						</div>
					...
					<div className="row">
						<div className="col-sm-4">
							<div className="thumbnail">
								...
								<div className="caption">
									<h3>
										<a href="team.html">Michael Bean</a>
									</h3>
									<p>Director</p>
									<p className="text-center social-icons">
										<a className="social-icon soc-facebook" href="#" title="Facebook" data-toggle="tooltip"></a>
										<a className="social-icon soc-twitter" href="#" title="Twitter" data-toggle="tooltip"></a>
										<a className="social-icon soc-google" href="#" title="Google" data-toggle="tooltip"></a>
									</p>
								</div>
							</div>
						</div>
						...
						<div className="col-sm-4">
							<div className="thumbnail">
								...
								<div className="caption">
									<h3>
										<a href="team.html">Mohamed Rahum</a>
									</h3>
									<p>SEO</p>
									<p className="text-center social-icons">
										<a className="social-icon soc-facebook" href="#" title="Facebook" data-toggle="tooltip"></a>
						...
						<div className="col-sm-4">
							<div className="thumbnail">
								...
								<div className="caption">
									<h3>
										<a href="team.html">Whitney Johnson</a>
									</h3>
									<p>Developer</p>
									<p className="text-center social-icons">
										<a className="social-icon soc-facebook" href="#" title="Facebook" data-toggle="tooltip"></a>
							...
							<div id="carousel-media" className="carousel slide testimonials-carousel" data-ride="carousel">
								...
								<div className="carousel-inner">
									<div className="item active">
										<div className="media">
											<a className="pull-left" href="#">
												<img className="media-object" src={require("./images/team/01.jpg")} alt=""/>
											</a>
									...
									<div className="item">
										<div className="media">
											<a className="pull-left" href="#">
												<img className="media-object" src={require("./images/team/02.jpg")} alt=""/>
											</a>
											<div className="media-body">
									...
									<div className="item">
										<div className="media">
											<a className="pull-left" href="#">
												<img className="media-object" src={require("./images/team/03.jpg")} alt=""/>
											</a>
											<div className="media-body">
												<h4>Michael Anderson</h4>
												<p>
								...
								<a className="right carousel-control" href="#carousel-media" role="button" data-slide="next">
