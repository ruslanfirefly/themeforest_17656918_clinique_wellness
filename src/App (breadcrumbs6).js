...
{//search modal
  ...
  {//wrappers for visual page editor and boxed version of template
	...
	<div id="canvas">
      ...
      <section id="breadcrumbs" className="page_breadcrumbs cs parallax section_padding_25">
      <div className="container">
        <div className="row">
        ...
        <ol className="breadcrumb bottom_breadcrumbs">
          <li>
            <a href="./">
              Home
            </a>
          ...
          <li className="active">Breadcrumbs 6</li>
        </ol>
      </div>
    </section>
