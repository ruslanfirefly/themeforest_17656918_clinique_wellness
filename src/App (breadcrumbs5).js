...
{//search modal
  ...
  {//wrappers for visual page editor and boxed version of template
	...
	<div id="canvas">
      ...
      <section id="breadcrumbs" className="page_breadcrumbs ls section_padding_25 bg_image">
      <div className="container">
        <div className="row">
          <div className="col-sm-12 text-center">
            <h1 className="small">Breadcrumbs 5</h1>
          </div>
        </div>
        <ol className="breadcrumb bottom_breadcrumbs greylinks">
          <li>
            <a href="./">
              Home
            </a>
          ...
          <li className="active">Breadcrumbs 5</li>
        </ol>
      </div>
    </section>
