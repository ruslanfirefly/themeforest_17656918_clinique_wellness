								...
								<div className="item-content entry-content">
									<header className="entry-header">
										...
										<h4 className="fontsize_30 topmargin_15 bottommargin_20 highlight">
											<a href="blog-single-video-full.html" rel="bookmark">Dolore incididunt fatback</a>
										</h4>
							...
							<article className="vertical-item post format-standard muted_background">
								...
								<div className="item-media entry-thumbnail">
									...
									<div className="media-links">
										<a className="abs-link" title="" href="blog-single-full.html"></a>
									</div>
								</div>
								...
								<div className="item-content entry-content">
									<header className="entry-header">
										...
										<h4 className="fontsize_30 topmargin_15 bottommargin_20 highlight">
											<a href="blog-single-video-full.html" rel="bookmark">Bacon do ham in. Chuck tenderloin laboris</a>
										</h4>
								...
								<div className="item-content entry-content">
									<header className="entry-header">
										...
										<h4 className="fontsize_30 topmargin_15 bottommargin_0 highlight">
											<a href="blog-single-video-full.html" rel="bookmark">Nulla short ribs jerky spare</a>
										</h4>
                  ...
                  <Carousel className="carousel-inner" showArrows={false} showThumbs={false}>
								...
								<div className="item-content entry-content">
									<header className="entry-header">
										...
										<h4 className="fontsize_30 topmargin_15 bottommargin_0 highlight">
											<a href="blog-single-video-full.html" rel="bookmark">Landjaeger jowl ut esse filet mignon</a>
										</h4>
								...
								<div className="item-content entry-content">
									<header className="entry-header">
										...
										<h4 className="fontsize_30 topmargin_15 bottommargin_15 highlight">
											<a href="blog-single-video-full.html" rel="bookmark">Nostrud pariatur fatback</a>
										</h4>
							...
							<article className="vertical-item post format-standard muted_background">
								...
								<div className="item-content entry-content">
									<header className="entry-header">
										...
										<h4 className="fontsize_30 topmargin_15 bottommargin_15 highlight">
											<a href="blog-single-video-full.html" rel="bookmark">Brisket turducken beef dolore</a>
										</h4>
