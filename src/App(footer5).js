...
<div id="box_wrapper">
	...
	<section className="page_breadcrumbs cs section_padding_20 columns_padding_0 table_section">
					...
					<div className="row">
						<div className="col-sm-4 text-center text-sm-left">
							<ol className="breadcrumb">
								...
								<li className="active">Footer 5</li>
							</ol>
						</div>
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Footer 5</h1>
						</div>
			...
			<footer className="page_contact ls parallax section_padding_top_75 section_padding_bottom_75 negative_margin">
				<div className="container">

					<div className="row">
						<div className="col-sm-12 text-center " data-animation="expandOpen">
					...
					<div className="row">
						<div className="col-sm-4">
							<div className="teaser text-center">
								...
								<p>
									<span className="grey">Phone:</span> +12 345 678 9123
									<br/>
									<span className="grey">Fax:</span> +12 345 678 9123
								</p>
					...
					<div className="row topmargin_40">
						<div className="col-sm-12  columns_padding_5">
							<form className="contact-form cs parallax" method="post" action="/">
								<div className="row">
									...
									<div className="col-sm-6">
										<p className="contact-form-name">
											...
											<input type="text" aria-required="true" size="30" value={this.state.name} onChange={(el)=>{this.setState({name: el.target.value})}} name="name" id="name" className="form-control" placeholder="Full Name"/>
										</p>
										<p className="contact-form-email">
											<label htmlFor="email" className="sr-only">Email address
												<span className="required">*</span>
											</label>
										...
										<p className="contact-form-subject">
											<label htmlFor="subject" className="sr-only">subject address
												<span className="required">*</span>
											</label>
								...
								<div className="row">
									<div className="col-sm-12">
										...
										<p className="contact-form-submit text-center topmargin_40">
