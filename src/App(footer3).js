					...
					<div className="row">
						<div className="col-sm-4 text-center text-sm-left">
							<ol className="breadcrumb">
								...
								<li className="active">Footer 3</li>
							</ol>
						</div>
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Footer 3</h1>
						</div>
						...
						<div className="col-md-3 col-sm-6 ">
							<div className="widget_text">
								...
								<p className="topmargin_40">
									<a href="#" className="theme_button">Buy Now!</a>
								</p>
							</div>
						</div>
								...
								<ul>
									<li>
										<p className="post-date">
											<a href="blog-single-right.html">02.01.2016</a>
										</p>
										<p>Lorem ipsum dolor simet </p>
									</li>
									<li>
										<p className="post-date">
											<a href="blog-single-right.html">04.01.2016 </a>
										</p>
										<p>Consetetur spselitrsed diam</p>
									</li>
									<li>
										<p className="post-date">
											<a href="blog-single-right.html">07.01.2016 </a>
										</p>
						...
						<div className="col-md-3 col-sm-6 ">
							<div className="widget_text">
								...
								<div className="border-paragraphs">
									<p>
										<i className="rt-icon2-device-phone highlight"></i> +12 345 678 9123
									</p>
									<p>
										<i className="rt-icon2-globe-outline highlight"></i>
										<a href="./">www.company.com</a>
									</p>
									<p>
										<i className="rt-icon2-mail2 highlight"></i>
