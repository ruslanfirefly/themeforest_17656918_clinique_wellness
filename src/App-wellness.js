  ...
  render() {
	...
	<div id="canvas">
		<div id="box_wrapper">
					...
					<div className="row">
						<div className="col-sm-4 text-center text-sm-left">
							<ol className="breadcrumb">
								...
								<li className="active">Wellness luxury spa resort</li>
							</ol>
						</div>
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Wellness luxury spa resort</h1>
						</div>
			...
			<section className="ls ms section_padding_top_110 section_padding_bottom_50">
				<div className="container">
					<div className="row">
						<div className="col-sm-12">
							<div className="tab-content architecture-tab-content text-center">
								<div className=" with_background" id="exterior">
									<div className="tab-media">
										...
										<ul className="tab-media-elements with_border thick_border mutted_border with_background no-bullets" role="tablist">
											<li className="item-media active">
												<a href="#exteriorr01" role="tab" data-toggle="tab" className="media-color4">
													<img src={require("./images/architecture/exterior01.jpg")} alt=""/>
												</a>
												{/* <div className="media-links"></div> */}
											</li>
											<li className="item-media">
												<a href="#exterior02" role="tab" data-toggle="tab" className="media-color4">
													<img src={require("./images/architecture/exterior02.jpg")} alt="" />
												</a>
											</li>
											<li className="item-media">
												<a href="#exterior03" role="tab" data-toggle="tab" className="media-color4">
													<img src={require("./images/architecture/exterior03.jpg")} alt="" />
												</a>
											</li>
											<li className="item-media">
												<a href="#exterior04" role="tab" data-toggle="tab" className="media-color4">
													<img src={require("./images/architecture/exterior04.jpg")} alt=""/>
												</a>
											</li>
			...
			<section className="ls section_padding_50">
				<div className="container">
					<div className="row">
						<div className="col-sm-12">
							<div className="tab-content architecture-tab-content content-left text-center">
								<div className=" with_background" id="interior">
			...
			<section className="ls ms section_padding_top_50 section_padding_bottom_110">
				<div className="container">
					<div className="row">
						<div className="col-sm-12">
							<div className="tab-content architecture-tab-content text-center">
								<div className=" with_background" id="equipment">
									<div className="tab-media">
										<div className="tab-content">
