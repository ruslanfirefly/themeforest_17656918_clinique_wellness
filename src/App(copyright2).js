...
<div id="box_wrapper">
	...
	<section className="page_breadcrumbs cs section_padding_20 columns_padding_0 table_section">
					...
					<div className="row">
						<div className="col-sm-4 text-center text-sm-left">
							<ol className="breadcrumb">
								...
								<li className="active">Copyright 2</li>
							</ol>
						</div>
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Copyright 2</h1>
						</div>
			...
			<section className="page_copyright ds section_padding_top_30 section_padding_bottom_15">
				<div className="container">
					<div className="row">
						<div className="col-sm-12 text-center">
							<a href="./" className="logo">
