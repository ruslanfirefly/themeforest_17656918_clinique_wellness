			...
			<section className="ls section_padding_110">
				<div className="container">
					...
					<div className="embed-responsive embed-responsive-3by2">
								<a href="https://www.youtube.com/embed/YE7VzlLtp-4" className="embed-placeholder">
										...
										<div className="row columns_padding_5">
											<div className="col-md-4">
												<p className="comment-form-author">
													<label htmlFor="author" className="sr-only">Full Name
														<span className="required">*</span>
													</label>
													{//<!-- <i className="rt-icon2-user-outline"></i> -->
													}
													<input type="text" aria-required="true" size="30" value={this.state.fullName} onChange={(el)=>{this.setState({fullName: el.target.value})}} name="author" id="author" className="form-control" placeholder="Full Name"/>
												</p>
											</div>
											<div className="col-md-4">
												<p className="comment-form-email">
													<label htmlFor="comment_email" className="sr-only">Email
														<span className="required">*</span>
													</label>
													{//<!-- <i className="rt-icon2-mail2"></i> -->
													}
													<input type="email" aria-required="true" size="30" value={this.state.email} onChange={(el)=>{this.setState({email: el.target.value})}} name="comment_email" id="comment_email" className="form-control" placeholder="Emain Address"/>
												</p>
											</div>
											<div className="col-md-4">
												<p className="comment-form-wesite">
													<label htmlFor="comment_wesite" className="sr-only">Email</label>
													{//<!-- <i className="rt-icon2-mail2"></i> -->
													}
													<input type="text" size="50" value={this.state.website} onChange={(el)=>{this.setState({website: el.target.value})}} name="comment_wesite" id="comment_wesite" className="form-control" placeholder="Website"/>
												</p>
											</div>
