		...
		<div id="box_wrapper">
				...
				<div className="container">
					<div className="row">
						...
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Progress Bars</h1>
						</div>
			...
			<section className="ls ms section_padding_50">
				<div className="container">
					<div className="row">
						<div className="col-sm-12 text-center">
							<h2 className="topmargin_0">Progress Bars</h2>
						</div>
						<div className="col-sm-6">
							...
							<div className="progress">
								<div className="progress-bar progress-bar-info" role="progressbar" data-transitiongoal="52">
									<span>52%</span>
								</div>
							</div>
						...
						<div className="col-sm-6">
							...
							<div className="progress">
								<div className="progress-bar progress-bar-warning" role="progressbar" data-transitiongoal="75">
									<span>75%</span>
								</div>
							</div>

							<div className="progress">
								<div className="progress-bar progress-bar-danger" role="progressbar" data-transitiongoal="95">
									<span>95%</span>
								</div>
							</div>
						...
						<div className="col-sm-12 text-center">
							...
							<div className="row text-center">
								<div className="col-sm-4">
									<div className="chart" data-percent="96">
								...
								<div className="col-sm-4">
									<div className="chart" data-percent="88">
										<span className="percent"></span>
										<h4>PHP</h4>
									</div>
								</div>
					...
					<div className="row">
						<div className="col-sm-12 text-center">
							<h2 className="divider_40">Progress Teasers</h2>
						</div>
						<div className="col-md-3 col-sm-6">
							...
							<div className="teaser text-center">
								...
								<h3 className="counter-wrap highlight" data-from="0" data-to="40" data-speed="1800">
									<span className="counter" data-from="0" data-to="20" data-speed="1500">0</span>
						...
						<div className="col-md-3 col-sm-6">
							...
							<div className="teaser text-center">
								...
								<h3 className="highlight counter-wrap">
									<span className="counter" data-from="0" data-to="100000" data-speed="1500">0</span>
									<span className="counter-add">+</span>
								</h3>
								<p>Likes</p>
							</div>
