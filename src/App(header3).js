			...
			<div>
				...
				<div id="canvas">
					<div id="box_wrapper">
							...
							<div className="container">
								<div className="row">
									...
									<div className="col-md-9 text-center text-md-right">
										...
										<span>
											<i v="rt-icon2-mail2 highlight fontsize_24"></i> support@company.com
					</span>
						...
						<header className="page_header header_gradient columns_padding_0">
							<div className="container">
								<div className="row">
					...
					<div className="row">
						<div className="col-sm-4 text-center text-sm-left">
							<ol className="breadcrumb">
								...
								<li className="active">Header 3</li>
							</ol>
						</div>
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Header 3</h1>
						</div>
