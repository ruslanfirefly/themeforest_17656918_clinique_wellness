  ...
  render() {
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section className="ls ms text-center section_padding_50">
				<div className="container">

					<div className="row">
						<div className="col-md-12">
							<h2 className="section_header " data-animation="slideDown" data-delay="150">Available Animations</h2>
						</div>
					</div>
					<div className="row">
						<div className="col-sm-12 " data-animation="scaleAppear" data-delay="150">
							<h3>.scaleAppear</h3>
							<p>Just add class
						...
						<div className="col-sm-12 " data-animation="fadeInLeft" data-delay="150">
							<h3>.fadeInLeft</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 " data-animation="fadeInUp" data-delay="150">
							<h3>.fadeInUp</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 " data-animation="fadeInRight" data-delay="150">
							<h3>.fadeInRight</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="fadeInDown" data-delay="150">
							<h3>.fadeInDown</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="fadeIn" data-delay="150">
							<h3>.fadeIn</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
					...
					<div className="row">
						<div className="col-sm-12 to_animate" data-animation="slideRight" data-delay="150">
							<h3>.slideRight</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="slideUp" data-delay="150">
							<h3>.slideUp</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="slideLeft" data-delay="150">
							<h3>.slideLeft</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
					...
					<div className="row">
						<div className="col-sm-12 to_animate" data-animation="expandUp" data-delay="150">
							<h3>.expandUp</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="slideExpandUp" data-delay="150">
							<h3>.slideExpandUp</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
					...
					<div className="row">
						<div className="col-sm-12 to_animate" data-animation="expandOpen" data-delay="150">
							<h3>.expandOpen</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="bigEntrance" data-delay="150">
							<h3>.bigEntrance</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="hatch" data-delay="150">
							<h3>.hatch</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
					...
					<div className="row">
						...
						<div className="col-sm-12 to_animate" data-animation="tossing" data-delay="150">
							<h3>.tossing</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="pulse" data-delay="150">
							<h3>.pulse</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="floating" data-delay="150">
							<h3>.floating</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
					...
					<div className="row">
						<div className="col-sm-12 to_animate" data-animation="bounce" data-delay="150">
							<h3>.bounce</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="pullUp" data-delay="150">
							<h3>.pullUp</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="pullDown" data-delay="150">
							<h3>.pullDown</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
					...
					<div className="row">
						<div className="col-sm-12 to_animate" data-animation="stretchLeft" data-delay="150">
							<h3>.stretchLeft</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="stretchRight" data-delay="150">
							<h3>.stretchRight</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
					...
					<div className="row">
						...
						<div className="col-sm-12 to_animate" data-animation="fadeInUpBig" data-delay="150">
							<h3>.fadeInUpBig</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="fadeInDownBig" data-delay="150">
							<h3>.fadeInDownBig</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
					...
					<div className="row">
						<div className="col-sm-12 to_animate" data-animation="fadeInLeftBig" data-delay="150">
							<h3>.fadeInLeftBig</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="fadeInRightBig" data-delay="150">
						...
						<div className="col-sm-12 to_animate" data-animation="slideInDown" data-delay="150">
							<h3>.slideInDown</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
					...
					<div className="row">
						<div className="col-sm-12 to_animate" data-animation="slideInLeft" data-delay="150">
							<h3>.slideInLeft</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="slideInRight" data-delay="150">
							<h3>.slideInRight</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-12 to_animate" data-animation="moveFromLeft" data-delay="150">
							<h3>.moveFromLeft</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
					...
					<div className="row">
						<div className="col-sm-6 to_animate" data-animation="moveFromRight" data-delay="150">
							<h3>.moveFromRight</h3>
							<p>Just add class
								<strong>"to_animate"</strong>, attributes
								<strong>"data-animation"</strong> with this class, and
						...
						<div className="col-sm-6 to_animate" data-animation="moveFromBottom" data-delay="150">
