...
<div id="box_wrapper">
	...
	<section className="page_breadcrumbs cs section_padding_20 columns_padding_0 table_section">
					...
					<div className="row">
						<div className="col-sm-4 text-center text-sm-left">
							<ol className="breadcrumb">
								...
								<li className="active">Copyright 5</li>
							</ol>
						</div>
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Copyright 5</h1>
						</div>
						...
						<div className="col-sm-12">
							<div className="row">
								<div className="col-sm-6">
									<h3 className="topmargin_0">Dolores Vel Reiciendis</h3>
								...
								<div className="col-sm-6">
									<h3 className="topmargin_0">Reprehenderit Nemo Alias</h3>
							...
							<div className="row">
								<div className="col-sm-4">
									<h3 className="topmargin_0">Laboriosam ducimus</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facere dolorem nisi unde itaque, aliquid. Necessitatibus, dolorem tempora repudiandae modi. Quis, esse eveniet suscipit! Enim dicta voluptate quas ea, facilis repellat!</p>
								</div>
								<div className="col-sm-4">
									<h3 className="topmargin_0">Necessitatibus Saepe</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut doloribus obcaecati incidunt quas iusto eos nobis. Laudantium veniam, reprehenderit nemo alias ducimus, illo, omnis voluptas doloribus cupiditate repudiandae porro numquam?</p>
								</div>
								<div className="col-sm-4">
									<h3 className="topmargin_0">Maxime Fugiat Error</h3>
							...
							<h3 className="topmargin_0">Consectetur Adipisicing Elit</h3>
			...
			<footer className="page_contact ls parallax section_padding_top_50 section_padding_bottom_60 columns_padding_25" data-stellar-background-ratio="0.5">
				<div className="container">
					<div className="row">

						<div className="col-sm-4  " data-animation="fadeIn">
							<h3 className="module-header">Contacts</h3>

							<div className="media small-teaser">
								<div className="media-left">
									<i className="rt-icon2-map2 highlight fontsize_24"></i>
								</div>
							...
							<div className="media small-teaser">
								<div className="media-left">
									<i className="rt-icon2-device-phone highlight fontsize_24"></i>
								</div>
								<div className="media-body">
									+65 (800) 695-2684
								</div>
							...
							<div className="media small-teaser">
								<div className="media-left">
									<i className="rt-icon2-printer2 highlight fontsize_24"></i>
								</div>
								<div className="media-body">
									+65 (800) 695-2686
								</div>
							...
							<div className="media small-teaser">
								<div className="media-left">
									<i className="rt-icon2-mail2 highlight fontsize_24"></i>
								</div>
								<div className="media-body">
						...
						<div className="col-sm-4   " data-animation="fadeIn">
							<h3 className="module-header">Send Message</h3>
							<form className="contact-form" method="post" action="/">
								<p className="contact-form-name">
									<label for="name" className="sr-only">Name
										<span className="required">*</span>
									</label>
									<input type="text" aria-required="true" size="30" value={this.state.fullName} onChange={(el)=>{this.setState({fullName: el.target.value})}} name="name" id="name" className="form-control" placeholder="Name"/>
								</p>
								...
								<p className="contact-form-message">
									...
									<textarea aria-required="true" rows="8" cols="45" name="message" id="message" className="form-control" placeholder="Message"></textarea>
								</p>
								<p className="contact-form-submit topmargin40">
									<button type="submit" id="contact_form_submit" name="contact_submit" className="theme_button color2">Send Message</button>
								</p>
							</form>
						...
						<div className="col-sm-4   " data-animation="fadeIn">
							<h3 className="module-header">Flickr Widget</h3>
			...
			<section className="page_copyright cs gradient section_padding_25 table_section table_section_md columns_padding_0">
				<div className="container">
					<div className="row">
						<div className="col-sm-3 text-md-left text-center">
							<a href="./" className="logo">
								<img src="/images/logo.png" alt="" className="main_bg_color"/>
								<h1>Clinique</h1>
							</a>
						...
						<div className="col-sm-6 text-center">
							<p>
								Copyright 2016. Solar by
								<a href="http://modernwebtemplates.com">MWTemplates</a>
							</p>
						</div>
						<div className="col-sm-3 text-center text-md-right">
