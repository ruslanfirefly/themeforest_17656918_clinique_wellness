				...
				<div className="container">
					<div className="row">
						...
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Timetable</h1>
						</div>
				...
				<div className="container">
					...
					<div className="row">
						<div className="col-sm-12">
							<h2 className="section_header small text-center">
								<strong>Alternative Energy School</strong>
							</h2>
						</div>
					</div>
					...
					<div className="row">
						<div className="text-center filters col-sm-12">
							<ul id="timetable_filter">
								<li>
									<a data-filter="all" href="#" className="selected">All</a>
								</li>
								<li>
									<a data-filter=".medical" href="#">medical</a>
								</li>
								<li>
									<a data-filter=".panels" href="#">panels</a>
								</li>
								<li>
								...
								<li>
									<a data-filter=".cosmetic" href="#">cosmetic</a>
								</li>
							</ul>
								...
								<table className="table_template darklinks" id="timetable">
									...
									<tbody>
										<tr>
											<th>8:00 - 9:00</th>
											<td>
												<a href="#" className="medical">
													Medical
												</a>
											</td>
											<td>
												<a href="#" className="meetings">
													Meetings
												</a>
											</td>
											<td>
											...
											<td>
												<a href="#" className="cosmetic">
													Cosmetic
												</a>
											</td>
											<td>
												<a href="#" className="presentations">
													Presentations
												</a>
											</td>
											<td>
