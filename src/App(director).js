...
<div id="box_wrapper">
	...
	<section className="page_breadcrumbs cs section_padding_20 columns_padding_0 table_section">
			...
			<section className="ls section_padding_top_100 section_padding_bottom_30 director director-page">
				<div className="container">
					<div className="row bottommargin_10">
						<div className="col-sm-12">
							<p className="fontsize_14 text-uppercase bold letter-spacing-033 grey bottommargin_15">15 years of experience</p>
							<h3 className="highlight topmargin_0 bottommargin_15">
								about me &amp; wellness luxury spa resort
							</h3>
						</div>
					</div>
					<div className="row display_table_lg">
						<div className="col-lg-4 col-md-12 display_table_cell_lg">
							<ul className="list1 director-media-list no-bullets margin_0">
								<li className="media">
									<div className="media-left media-middle">
										<img src="/images/director-media01.jpg" alt="" className="round"/>
									</div>
									<div className="media-body media-middle">
										<h6 className="topmargin_0 bottommargin_5">Excellent exterior</h6>
										<p className="margin_0">Ea laborum pancetta, biltong duis elit t-bone andouille velit veniam proident.</p>
									</div>
								</li>
								<li className="media">
									<div className="media-left media-middle">
										<img src="/images/director-media02.jpg" alt="" className="round"/>
									</div>
									<div className="media-body media-middle">
										<h6 className="topmargin_0 bottommargin_5">luxury interior</h6>
										<p className="margin_0">Nisi est andouille pork belly ribeye frankfurter commodo kevin cillum pork.</p>
									</div>
								</li>
								<li className="media">
									<div className="media-left media-middle">
										<img src="/images/director-media03.jpg" alt="" className="round"/>
									</div>
									<div className="media-body media-middle">
										<h6 className="topmargin_0 bottommargin_5">specialized equipment</h6>
										<p className="margin_0">Tri-tip sint sed filet mignon. Sunt andouille prosciutto, labore minim.</p>
									</div>
								</li>
							</ul>

						</div>
						<div className="col-lg-6 col-md-7 text-center display_table_cell_lg">
							<div className="founding-date-cont">
								<img src="/images/director.png" alt=""/>
							</div>
						</div>
						<div className="col-lg-2 col-md-5 text-center text-md-left display_table_cell_lg">
			...
			<section className="ls ms section_padding_100 director">
				<div className="container">
					<div className="row">
						<div className="col-sm-12">
							...
							<p className="bottommargin_25">
								Corned beef tail turducken ribeye qui ham nisi pastrami shoulder tenderloin esse pork loin. Shank tenderloin jowl, quis anim bresaola dolore. Pork belly tongue lorem officia. In tail magna leberkas flank ex. Laboris pork loin cillum, sunt reprehenderit
								prosciutto minim jerky nulla in elit. Ham hock doner cillum jerky cupim aliqua. Capicola tail landjaeger, anim picanha tongue swine chicken bresaola et occaecat prosciutto andouille.
							</p>
							<p className="margin_0">
								Strip steak est doner biltong ullamco sirloin ut. Pork loin ham hock jowl doner labore flank occaecat ham andouille swine irure. Nisi elit adipisicing flank swine in exercitation incididunt. Chicken tongue sint, excepteur ham commodo velit biltong. Do
								sausage meatball turkey elit, chuck tri-tip swine eu culpa commodo.
							</p>
						</div>
					</div>
				</div>
