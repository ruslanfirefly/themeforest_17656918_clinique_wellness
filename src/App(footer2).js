					...
					<div className="row">
						<div className="col-sm-4 text-center text-sm-left">
							<ol className="breadcrumb">
								...
								<li className="active">Footer 2</li>
							</ol>
						</div>
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Footer 2</h1>
						</div>
					...
					<div className="col-sm-4 " data-animation="fadeIn">
						...
						<form className="contact-form" method="post" action="/">
							<p className="contact-form-name">
								...
								<input type="text" aria-required="true" size="30" value={this.state.name} onChange={(el)=>{this.setState({name: el.target.value})}} name="name" id="name" className="form-control" placeholder="Name"/>
							</p>
