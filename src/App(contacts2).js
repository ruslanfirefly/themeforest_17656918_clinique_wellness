					...
					<div className="row">
						<div className="col-sm-4 text-center text-sm-left">
							<ol className="breadcrumb">
								...
								<li className="active">Contact 2</li>
							</ol>
						</div>
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Contact 2</h1>
						</div>
				...
				<div className="container">
					<div className="row">
						<div className="col-sm-12">
							<section id="map" className="ls ms"></section>
						</div>
					</div>
					...
					<div className="row topmargin_40">
						<div className="col-sm-4 " data-animation="pullDown">
							<div className="teaser text-center">
								<div className="teaser_icon highlight2 size_normal">
					...
					<div className="row">
						<div className="col-sm-12 ">
							<form className="contact-form columns_padding_5 bold-placeholder" method="post" action="/">
								<div className="row">
