  ...
  var pluginName = 'selectric',
      ...
      Selectric = function(element, opts) {
        ...
        function _init(opts) {
          ...
          $label        = $('<div className="selectric-label"/>');
          ...
          $original.on(eventTriggers).wrap('<div className="' + _this.classes.hideselect + '">');
          ...
          if ( optionsLength = $options.length ) {
            ...
            $options.each(function() {
              ...
              if ( $elm.is('optgroup') ) {
                ...
                _$li += _utils.format('<ul className="{1}"><li className="{2}">{3}</li>',
              ...
              function buildOption() {
                ...
                _$li += _utils.format('<li data-index="{1}" className="{2}">{3}</li>',
                  currIndex,
