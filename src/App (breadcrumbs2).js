  ...
  {//wrappers for visual page editor and boxed version of template
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section id="breadcrumbs" className="page_breadcrumbs cs section_padding_50 gradient table_section table_section_md columns_padding_0">
				<div className="container">
					<div className="row">
						<div className="col-md-6 text-center text-md-left">
							<h1 className="small">Breadcrumbs 2</h1>
						</div>
						<div className="col-md-6 text-center text-md-right">
							<ol className="breadcrumb">
								...
								<li className="active">Breadcrumbs 2</li>
							</ol>
						</div>
					</div>
				</div>
