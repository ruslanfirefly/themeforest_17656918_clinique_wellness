...
<div id="box_wrapper">
	...
	<section className="page_breadcrumbs cs section_padding_20 columns_padding_0 table_section">
					...
					<div className="row">
						<div className="col-sm-4 text-center text-sm-left">
							<ol className="breadcrumb">
								...
								<li className="active">Coming Soon 1</li>
							</ol>
						</div>
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Coming Soon 1</h1>
						</div>
			...
			<section id="comingsoon1" className="ls section_padding_top_75 section_padding_bottom_100">
				<div className="container">
					<div className="row">
						<div className="col-sm-12 text-center">

							<div id="comingsoon-countdown" className="is-countdown">
							<Countdown className="countdown-row countdown-show4" date={Date.now() + 2592000000} renderer={renderer}/>
							</div>
					...
					<div className="row">
						<div className="col-md-4 col-md-push-4 col-sm-6 col-sm-push-3 text-center">
