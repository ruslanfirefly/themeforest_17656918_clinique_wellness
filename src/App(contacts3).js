					...
					<div className="row">
						<div className="col-sm-4 text-center text-sm-left">
							<ol className="breadcrumb">
								...
								<li className="active">Contact 3</li>
							</ol>
						</div>
						<div className="col-sm-4 text-center">
							<h1 className="highlight bold">Contact 3</h1>
						</div>
				...
				<div className="container">
					...
					<div className="row">
						<div className="col-sm-12 ">
							<form className="contact-form cs parallax columns_padding_5 bold-placeholder" method="post" action="/">
								<div className="row">
								...
								<div className="row">
									<div className="col-sm-12">
										...
										<p className="contact-form-submit text-center topmargin_30">
											<button type="submit" id="contact_form_submit" name="contact_submit" className="theme_button">Send Message</button>
										</p>
									</div>
